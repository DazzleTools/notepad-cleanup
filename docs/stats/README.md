...
Interactive dashboard showing traffic analytics for [notepad-cleanup](https://github.com/DazzleTools/notepad-cleanup).
...
|--------|------|----------|
| [Badge Gist](https://gist.github.com/djdarcy/a165031b15ecf9b6fdac066d0222a591) | Public | Current stats, rolling 31-day daily history |
...
**https://dazzletools.github.io/notepad-cleanup/stats/**
